...
return {
  ...
  version = version,
  release = 1,
  summary = "LXQt menu files",
  license = "LGPL-2.1-or-later",
  arch = { "x86_64", "aarch64" },
  source = {
    url = "https://github.com/lxqt/lxqt-menu-data/releases/download/" .. version .. "/lxqt-menu-data-" .. version .. ".tar.xz",
    sha256 = "d2d2187313c16fc435a7313e53b80ace7ccba0b5de6c0d9cd53bfdfa13d5eab4",
  },
  build = {
    system = "cmake",
    deps = { "cmake", "ninja", "pkgconf", "gcc", "lxqt-build-tools", "qt6-tools" },
    script = [[
#!/bin/sh
