...
inchroot "xbps-install -Sy base-system linux dracut btrfs-progs dosfstools gptfdisk parted rsync squashfs-tools curl ca-certificates grub grub-${VOID_ARCH}-efi efibootmgr NetworkManager dbus elogind polkit seatd sudo zstd xz bzip2 tar debootstrap"
