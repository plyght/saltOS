...
static void usage() {
  fprintf(stderr,
          ...
          "      [--allow-unverified] [--download-only] [--dry-run] [--nodeps] [--locked "
          "[--lockfile F]]\n"
          ...
          "  config <subcommand>  declarative config: show, check, apply, diff, history, rollback, "
          "gc\n\n"
          "maintainer commands:\n"
          ...
          "                       package entry gets an absolute url = <url-base>/<filename>\n"
